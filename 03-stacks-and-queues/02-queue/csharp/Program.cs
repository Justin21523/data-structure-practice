    ...
    {  // Open class scope.  
        ...
        {  // Open method scope.  
            {  // Open scope: FIFO tests.  
                var q = new QueueDemo.ArrayQueue();  // Start with empty queue.  
            ...
            {  // Open scope: resize copy tests.  
                var q = new QueueDemo.ArrayQueue();  // Start with empty queue (capacity=1).  
            ...
            {  // Open scope: dequeue moved tests.  
                ...
                {  // Open foreach scope.  
                    ...
                    AssertEqual(expectedMoved, r.Cost.Moved, "dequeue moved should equal max(0,n-1)");  // Validate moved count.  
            ...
            {  // Open scope: empty-operation tests.  
                var q = new QueueDemo.ArrayQueue();  // Create empty queue.  
        ...
        {  // Open method scope.  
            ...
            {  // Open foreach scope.  
                QueueDemo.EnqueueSummary s = QueueDemo.SimulateEnqueues(m);  // Simulate and summarize.  
        ...
        private static string FormatDequeueCostTable(IReadOnlyList<int> ns)  // Show dequeue shift costs at multiple sizes.  
        {  // Open method scope.  
            ...
            {  // Open foreach scope.  
                int moved = n == 0 ? 0 : QueueDemo.SimulateDequeueCostAtSize(n).Moved;  // Skip invalid dequeue on empty queue.  
        ...
        {  // Open method scope.  
            var q = new QueueDemo.ArrayQueue();  // Create an empty queue.  
        ...
        {  // Open method scope.  
            ...
            {  // Open try scope.  
                ...
                Console.WriteLine("=== Dequeue Shift Cost (dequeue once from size n) ===");  // Print section title.  
